    ...
    <div class="col-xs-12">
      ...
      <div class="box">
        <div class="box-header">
          <h3 class="box-title d-print-block">Subscription request</h3>
        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
              <?php 
                $no=0;
                $sql="SELECT * from subscribe JOIN customer on subscribe.nik=customer.nik where aktif='waiting' order by time desc";
                $query = mysqli_query($con, $sql);
...
$gateway=mysqli_fetch_array(mysqli_query($con,"SELECT * from gateway where id_gateway='".$setor['gateway']."'"));
        ...
        <div class="panel-body">
            ...
            <form method="POST" class="form-row">
                    ...
                    <button type="button" class="col-lg-4 col-md-4 col-xs-12 btn btn-primary " data-toggle="modal" title="Send message" data-target="#message<?=$row['id_subscribe']?>"><i class="fa fa-envelope"></i></button>
                  </form>
            </div>
        </div>
    </div>
