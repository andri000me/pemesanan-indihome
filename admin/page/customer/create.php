<?php 
  if (isset($_POST['simpan'])) {
      ...
      $a=$_FILES['photo']['name'];
      $query="INSERT INTO customer values ('".$_POST['NIK']."','".$_POST['nama']."','".$_POST['pob']."','".$_POST['dob']."','".$_POST['tel']."','".$_POST['email']."','".$_POST['alamat']."','".$_POST['rw']."','".$_POST['rt']."','".$a."')";
    ...
    if ($sql) {
      ...
      $inputuser="INSERT INTO user values (null,'".$_POST['nama']."','".$_POST['NIK']."','".$_POST['NIK']."','customer',null)";
      mysqli_query($con,$inputuser);
      //echo $inputuser;
      echo "<script>alert('Data berhasil ditambah!');window.location.href='?p=customer'</script>";
    }else{
      echo "<script>alert('Penambahan data gagal!');window.location.href='?p=customer'</script>";
    }
  }
    ...
    <div class="col-md-8">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Form input customer baru</h3>
        ...
        <form role="form" method="post"  enctype="multipart/form-data">
          <div class="box-body">
            <div class="form-group">
              <label for="exampleInputEmail1">Nama customer Baru</label>
