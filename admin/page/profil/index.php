<?php 
  $NIK=$_SESSION['NIK'];
  $edit=mysqli_fetch_array(mysqli_query($con,"SELECT * from customer where customer.NIK = '".$NIK."'"));
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <div class="col-lg-12 row mb-2 mt-2">
          	<div class="col-md-6">
          		<img style="border-radius: 50%; height: 250px" src="assets/img/customer/<?=$_SESSION['img']?>" class="user-image">
          	</div>
          	<div class="col-md-6">
          		<table>
          			<tr>
          			...
          			<tr>
          				...
          				<td>
          					<input required disabled type="text" value="<?=$edit['nama_customer']?>" class="profil-input">
          				</td>
          			</tr>
          			<tr>
