<?php 
  ...
  if (isset($_POST['simpan'])) {
      ...
      $a=$_FILES['photo']['name'];
        ...
        if (strlen($a)>0) {
            if (is_uploaded_file($_FILES['photo']['tmp_name'])) {
              move_uploaded_file($_FILES['photo']['tmp_name'], "assets/img/customer/".$a);
              $img=",img='".$a."'";
            }
    }else{
      $img="";
    ...
    if ($sql) {
      ...
      $jab=mysqli_fetch_array(mysqli_query($con,"SELECT * from customer join jabatan on customer.jabatan=jabatan.id where customer.NIK = '".$_POST['NIK']."'"));
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-2">
                  ...
                  <img width="100%" alt="<?=$edit['img']?>" title="<?=$edit['img']?>" src="assets/img/customer/<?=$edit['img']?>">
                </div>
              </div>
